...
class MainPage(BasePage):
    ...
    @property
    def char_name(self):
        return self.altdriver.find_object(By.NAME, 'CharName')



    def char_name_txt(self):
        self.char_name.tap()
        sleep(5)
    ...
    def is_displayed(self):
        if self.start_button and self.store_button and self.mission_button and self.setting_button and self.char_name:
            return True
